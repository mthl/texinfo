...
$result_trees{'node_on_index_entry_line'}{'contents'}[1]{'args'}[1]{'extra'}{'spaces_before_argument'} = $result_trees{'node_on_index_entry_line'}{'contents'}[1]{'args'}[1]{'contents'}[0];
...
$result_trees{'node_on_index_entry_line'}{'contents'}[1]{'args'}[2]{'extra'}{'spaces_before_argument'} = $result_trees{'node_on_index_entry_line'}{'contents'}[1]{'args'}[2]{'contents'}[0];
...
$result_trees{'node_on_index_entry_line'}{'contents'}[1]{'args'}[3]{'extra'}{'spaces_before_argument'} = $result_trees{'node_on_index_entry_line'}{'contents'}[1]{'args'}[3]{'contents'}[0];
