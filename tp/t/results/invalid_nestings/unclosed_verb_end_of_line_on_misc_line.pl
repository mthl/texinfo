...
$result_trees{'unclosed_verb_end_of_line_on_misc_line'}{'contents'}[0]{'line_nr'} = $result_trees{'unclosed_verb_end_of_line_on_misc_line'}{'contents'}[0]{'args'}[0]{'contents'}[1]{'line_nr'};
