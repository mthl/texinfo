...
$result_trees{'on_block_command_line'}{'contents'}[2]{'args'}[0]{'contents'}[7]{'extra'}{'misc_content'} = $result_trees{'on_block_command_line'}{'contents'}[2]{'args'}[0]{'contents'}[7]{'args'}[0]{'contents'};
