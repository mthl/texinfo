...
$result_trees{'style_not_closed_no_newline_root_commands'}{'contents'}[2]{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'style_not_closed_no_newline_root_commands'}{'contents'}[2]{'contents'}[1]{'contents'}[0];
...
$result_trees{'style_not_closed_no_newline_root_commands'}{'contents'}[2]{'extra'}{'misc_content'}[0] = $result_trees{'style_not_closed_no_newline_root_commands'}{'contents'}[2]{'args'}[0]{'contents'}[0];
...
$result_trees{'style_not_closed_no_newline_root_commands'}{'contents'}[4]{'extra'}{'misc_content'}[0] = $result_trees{'style_not_closed_no_newline_root_commands'}{'contents'}[4]{'args'}[0]{'contents'}[0];
...
$result_nodes{'style_not_closed_no_newline_root_commands'}{'menus'}[0]{'extra'}{'spaces_after_command_elt'}{'extra'}{'command'} = $result_nodes{'style_not_closed_no_newline_root_commands'}{'menus'}[0];
