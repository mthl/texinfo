...
$result_trees{'quotation_in_style_command'}{'contents'}[1]{'contents'}[2]{'extra'}{'spaces_after_command'} = $result_trees{'quotation_in_style_command'}{'contents'}[1]{'contents'}[2]{'args'}[0]{'contents'}[0];
...
$result_trees{'quotation_in_style_command'}{'contents'}[1]{'extra'}{'spaces_after_command'} = $result_trees{'quotation_in_style_command'}{'contents'}[1]{'contents'}[0];
