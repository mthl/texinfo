...
$result_trees{'printindex_index_entry_in_copying'}{'contents'}[0]{'contents'}[0]{'contents'}[4]{'contents'}[0]{'extra'}{'index_entry'}{'content_normalized'} = $result_trees{'printindex_index_entry_in_copying'}{'contents'}[0]{'contents'}[0]{'contents'}[4]{'contents'}[0]{'extra'}{'index_entry'}{'content'};
...
$result_trees{'printindex_index_entry_in_copying'}{'contents'}[0]{'contents'}[0]{'contents'}[4]{'contents'}[1]{'extra'}{'index_entry'}{'content_normalized'} = $result_trees{'printindex_index_entry_in_copying'}{'contents'}[0]{'contents'}[0]{'contents'}[4]{'contents'}[1]{'extra'}{'index_entry'}{'content'};
...
<dl class="def">
<dt id="index-copying-fun"><span class="category">Function: </span><strong>fun</strong> <em>arg</em><a href=\'#index-copying-fun\' class=\'copiable-anchor\'>&para;</a></dt>
<dt id="index-copying-xf"><span class="category">Function: </span><strong>xf</strong> <em>arg</em><a href=\'#index-copying-xf\' class=\'copiable-anchor\'>&para;</a></dt>
<dd><p>Defun
</p></dd></dl>

<dl compact="compact">
<dt id=\'index-copying-ftable-item\'>ftable item<a href=\'#index-copying-ftable-item\' class=\'copiable-anchor\'>&para;</a></dt>
<dt id=\'index-copying-xftable-xitem\'>xftable xitem<a href=\'#index-copying-xftable-xitem\' class=\'copiable-anchor\'>&para;</a></dt>
</dl>
