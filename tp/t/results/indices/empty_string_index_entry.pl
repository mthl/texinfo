...
$result_trees{'empty_string_index_entry'}{'contents'}[1]{'contents'}[5]{'contents'}[0]{'extra'}{'index_entry'}{'content_normalized'} = $result_trees{'empty_string_index_entry'}{'contents'}[1]{'contents'}[5]{'contents'}[0]{'extra'}{'index_entry'}{'content'};
...
$result_trees{'empty_string_index_entry'}{'contents'}[1]{'contents'}[5]{'contents'}[1]{'extra'}{'index_entry'}{'content_normalized'} = $result_trees{'empty_string_index_entry'}{'contents'}[1]{'contents'}[5]{'contents'}[1]{'extra'}{'index_entry'}{'content'};
...
<dl compact="compact">
<dt id=\'index--1\'><code><!-- /@w --></code><a href=\'#index--1\' class=\'permalink\'>&para;</a></dt>
</dl>

<dl class="def">
<dt id="index--2"><span class="category">Function: </span><strong><!-- /@w --></strong> <em> </em><a href=\'#index--2\' class=\'permalink\'>&para;</a></dt>
<dt id="index--3"><span class="category">Function: </span><strong><!-- /@w --></strong> <em> </em><a href=\'#index--3\' class=\'permalink\'>&para;</a></dt>
</dl>
