...
$result_trees{'cond_info_ifhtml_ifinfo_iftex'}{'contents'}[1]{'extra'}{'nodes_manuals'}[0]{'node_content'} = $result_trees{'cond_info_ifhtml_ifinfo_iftex'}{'contents'}[1]{'extra'}{'node_content'};
...
$result_nodes{'cond_info_ifhtml_ifinfo_iftex'}{'node_up'}{'extra'}{'top_node_up'} = $result_nodes{'cond_info_ifhtml_ifinfo_iftex'};
