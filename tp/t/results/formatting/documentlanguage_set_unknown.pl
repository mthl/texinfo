...
$result_trees{'documentlanguage_set_unknown'}{'contents'}[1]{'extra'}{'nodes_manuals'}[0]{'node_content'} = $result_trees{'documentlanguage_set_unknown'}{'contents'}[1]{'extra'}{'node_content'};
...
$result_nodes{'documentlanguage_set_unknown'}{'node_up'}{'extra'}{'top_node_up'} = $result_nodes{'documentlanguage_set_unknown'};
