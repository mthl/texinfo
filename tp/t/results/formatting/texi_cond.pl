...
$result_trees{'texi_cond'}{'contents'}[0]{'contents'}[1]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'texi_cond'}{'contents'}[0]{'contents'}[1]{'args'}[0];
$result_trees{'texi_cond'}{'contents'}[0]{'contents'}[1]{'args'}[0]{'parent'} = $result_trees{'texi_cond'}{'contents'}[0]{'contents'}[1];
$result_trees{'texi_cond'}{'contents'}[0]{'contents'}[1]{'parent'} = $result_trees{'texi_cond'}{'contents'}[0];
$result_trees{'texi_cond'}{'contents'}[0]{'contents'}[2]{'parent'} = $result_trees{'texi_cond'}{'contents'}[0];
...
$result_nodes{'texi_cond'}{'node_up'}{'extra'}{'top_node_up'} = $result_nodes{'texi_cond'};
