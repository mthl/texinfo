...
$result_trees{'split_test_before_first_node'}{'contents'}[0]{'contents'}[0]{'args'}[0]{'contents'}[1]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[0]{'contents'}[0]{'args'}[0];
$result_trees{'split_test_before_first_node'}{'contents'}[0]{'contents'}[0]{'args'}[0]{'contents'}[2]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[0]{'contents'}[0]{'args'}[0];
...
$result_trees{'split_test_before_first_node'}{'contents'}[0]{'contents'}[0]{'extra'}{'spaces_after_command'} = $result_trees{'split_test_before_first_node'}{'contents'}[0]{'contents'}[0]{'args'}[0]{'contents'}[0];
...
$result_trees{'split_test_before_first_node'}{'contents'}[1]{'args'}[0]{'contents'}[1]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[1]{'args'}[0];
$result_trees{'split_test_before_first_node'}{'contents'}[1]{'args'}[0]{'contents'}[2]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[1]{'args'}[0];
$result_trees{'split_test_before_first_node'}{'contents'}[1]{'args'}[0]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[1];
$result_trees{'split_test_before_first_node'}{'contents'}[1]{'extra'}{'node_content'}[0] = $result_trees{'split_test_before_first_node'}{'contents'}[1]{'args'}[0]{'contents'}[1];
...
$result_trees{'split_test_before_first_node'}{'contents'}[1]{'extra'}{'spaces_after_command'} = $result_trees{'split_test_before_first_node'}{'contents'}[1]{'args'}[0]{'contents'}[0];
...
$result_trees{'split_test_before_first_node'}{'contents'}[2]{'args'}[0]{'contents'}[1]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[2]{'args'}[0];
$result_trees{'split_test_before_first_node'}{'contents'}[2]{'args'}[0]{'contents'}[2]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[2]{'args'}[0];
...
$result_trees{'split_test_before_first_node'}{'contents'}[2]{'contents'}[3]{'contents'}[2]{'args'}[0]{'contents'}[1]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[2]{'contents'}[3]{'contents'}[2]{'args'}[0];
$result_trees{'split_test_before_first_node'}{'contents'}[2]{'contents'}[3]{'contents'}[2]{'args'}[0]{'contents'}[2]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[2]{'contents'}[3]{'contents'}[2]{'args'}[0];
...
$result_trees{'split_test_before_first_node'}{'contents'}[2]{'contents'}[3]{'contents'}[2]{'extra'}{'spaces_after_command'} = $result_trees{'split_test_before_first_node'}{'contents'}[2]{'contents'}[3]{'contents'}[2]{'args'}[0]{'contents'}[0];
...
$result_trees{'split_test_before_first_node'}{'contents'}[2]{'contents'}[3]{'extra'}{'spaces_after_command'} = $result_trees{'split_test_before_first_node'}{'contents'}[2]{'contents'}[3]{'contents'}[0];
...
$result_trees{'split_test_before_first_node'}{'contents'}[2]{'extra'}{'misc_content'}[0] = $result_trees{'split_test_before_first_node'}{'contents'}[2]{'args'}[0]{'contents'}[1];
$result_trees{'split_test_before_first_node'}{'contents'}[2]{'extra'}{'spaces_after_command'} = $result_trees{'split_test_before_first_node'}{'contents'}[2]{'args'}[0]{'contents'}[0];
...
$result_trees{'split_test_before_first_node'}{'contents'}[3]{'args'}[0]{'contents'}[1]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[3]{'args'}[0];
$result_trees{'split_test_before_first_node'}{'contents'}[3]{'args'}[0]{'contents'}[2]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[3]{'args'}[0];
$result_trees{'split_test_before_first_node'}{'contents'}[3]{'args'}[0]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[3];
$result_trees{'split_test_before_first_node'}{'contents'}[3]{'extra'}{'node_content'}[0] = $result_trees{'split_test_before_first_node'}{'contents'}[3]{'args'}[0]{'contents'}[1];
...
$result_trees{'split_test_before_first_node'}{'contents'}[3]{'extra'}{'spaces_after_command'} = $result_trees{'split_test_before_first_node'}{'contents'}[3]{'args'}[0]{'contents'}[0];
...
$result_trees{'split_test_before_first_node'}{'contents'}[4]{'args'}[0]{'contents'}[1]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[4]{'args'}[0];
$result_trees{'split_test_before_first_node'}{'contents'}[4]{'args'}[0]{'contents'}[2]{'parent'} = $result_trees{'split_test_before_first_node'}{'contents'}[4]{'args'}[0];
...
$result_trees{'split_test_before_first_node'}{'contents'}[4]{'extra'}{'misc_content'}[0] = $result_trees{'split_test_before_first_node'}{'contents'}[4]{'args'}[0]{'contents'}[1];
$result_trees{'split_test_before_first_node'}{'contents'}[4]{'extra'}{'spaces_after_command'} = $result_trees{'split_test_before_first_node'}{'contents'}[4]{'args'}[0]{'contents'}[0];
