...
$result_trees{'split_no_copying'}{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'split_no_copying'}{'contents'}[2]{'args'}[0]{'contents'};
...
$result_trees{'split_no_copying'}{'contents'}[4]{'extra'}{'misc_content'} = $result_trees{'split_no_copying'}{'contents'}[4]{'args'}[0]{'contents'};
