...
$result_trees{'float_long_captions'}{'contents'}[1]{'contents'}[1]{'args'}[1]{'extra'}{'spaces_before_argument'} = $result_trees{'float_long_captions'}{'contents'}[1]{'contents'}[1]{'args'}[1]{'contents'}[0];
...
$result_trees{'float_long_captions'}{'contents'}[1]{'contents'}[3]{'args'}[1]{'extra'}{'spaces_before_argument'} = $result_trees{'float_long_captions'}{'contents'}[1]{'contents'}[3]{'args'}[1]{'contents'}[0];
