...
$result_trees{'enumerate_argument_item'}{'contents'}[0]{'extra'}{'block_command_line_contents'}[0][0] = $result_trees{'enumerate_argument_item'}{'contents'}[0]{'args'}[0]{'contents'}[0];
...
$result_trees{'enumerate_argument_item'}{'contents'}[2]{'extra'}{'block_command_line_contents'}[0][0] = $result_trees{'enumerate_argument_item'}{'contents'}[2]{'args'}[0]{'contents'}[0];
$result_trees{'enumerate_argument_item'}{'contents'}[2]{'extra'}{'comment_at_end'}{'args'}[0]{'parent'} = $result_trees{'enumerate_argument_item'}{'contents'}[2]{'extra'}{'comment_at_end'};
$result_trees{'enumerate_argument_item'}{'contents'}[2]{'extra'}{'comment_at_end'}{'parent'} = $result_trees{'enumerate_argument_item'}{'contents'}[2]{'args'}[0];
...
$result_trees{'enumerate_argument_item'}{'contents'}[4]{'extra'}{'block_command_line_contents'}[0][0] = $result_trees{'enumerate_argument_item'}{'contents'}[4]{'args'}[0]{'contents'}[0];
$result_trees{'enumerate_argument_item'}{'contents'}[4]{'extra'}{'comment_at_end'}{'args'}[0]{'parent'} = $result_trees{'enumerate_argument_item'}{'contents'}[4]{'extra'}{'comment_at_end'};
$result_trees{'enumerate_argument_item'}{'contents'}[4]{'extra'}{'comment_at_end'}{'parent'} = $result_trees{'enumerate_argument_item'}{'contents'}[4]{'args'}[0];
