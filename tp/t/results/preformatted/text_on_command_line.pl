...
$result_trees{'text_on_command_line'}{'contents'}[0]{'extra'}{'block_command_line_contents'}[0][0] = $result_trees{'text_on_command_line'}{'contents'}[0]{'args'}[0]{'contents'}[0];
...
$result_trees{'text_on_command_line'}{'contents'}[2]{'extra'}{'block_command_line_contents'}[0][0] = $result_trees{'text_on_command_line'}{'contents'}[2]{'args'}[0]{'contents'}[0];
...
$result_trees{'text_on_command_line'}{'contents'}[4]{'extra'}{'spaces_after_command_elt'} = $result_trees{'text_on_command_line'}{'contents'}[4]{'contents'}[0];
...
$result_trees{'text_on_command_line'}{'contents'}[6]{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'text_on_command_line'}{'contents'}[6]{'contents'}[1]{'contents'}[0];
...
$result_trees{'text_on_command_line'}{'contents'}[6]{'extra'}{'spaces_after_command_elt'} = $result_trees{'text_on_command_line'}{'contents'}[6]{'contents'}[0];
