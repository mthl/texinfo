...
$result_trees{'nested_formats'}{'contents'}[0]{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'nested_formats'}{'contents'}[0]{'contents'}[1]{'contents'}[0];
...
$result_trees{'nested_formats'}{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'nested_formats'}{'contents'}[0]{'contents'}[0];
...
$result_trees{'nested_formats'}{'contents'}[2]{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'nested_formats'}{'contents'}[2]{'contents'}[1]{'contents'}[0];
...
$result_trees{'nested_formats'}{'contents'}[2]{'extra'}{'spaces_after_command_elt'} = $result_trees{'nested_formats'}{'contents'}[2]{'contents'}[0];
