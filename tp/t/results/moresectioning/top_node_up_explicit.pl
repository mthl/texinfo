...
$result_trees{'top_node_up_explicit'}{'contents'}[1]{'extra'}{'nodes_manuals'}[3]{'top_node_up'} = $result_trees{'top_node_up_explicit'}{'contents'}[1];
...
$result_nodes{'top_node_up_explicit'}{'node_up'}{'extra'}{'top_node_up'} = $result_nodes{'top_node_up_explicit'};
