...
$result_trees{'empty_quotation_with_arg_followed_by_quotation'}{'contents'}[2]{'extra'}{'spaces_after_command_elt'} = $result_trees{'empty_quotation_with_arg_followed_by_quotation'}{'contents'}[2]{'contents'}[0];
