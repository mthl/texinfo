...
$result_trees{'example_in_menu_comment'}{'contents'}[0]{'contents'}[2]{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'example_in_menu_comment'}{'contents'}[0]{'contents'}[2]{'contents'}[1]{'contents'}[0];
...
$result_trees{'example_in_menu_comment'}{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'example_in_menu_comment'}{'contents'}[0]{'contents'}[0];
