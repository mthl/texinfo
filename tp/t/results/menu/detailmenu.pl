...
$result_trees{'detailmenu'}{'contents'}[1]{'contents'}[3]{'extra'}{'spaces_after_command_elt'} = $result_trees{'detailmenu'}{'contents'}[1]{'contents'}[3]{'contents'}[0];
...
$result_trees{'detailmenu'}{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'detailmenu'}{'contents'}[1]{'contents'}[0];
