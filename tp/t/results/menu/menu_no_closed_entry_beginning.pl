...
$result_trees{'menu_no_closed_entry_beginning'}{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'menu_no_closed_entry_beginning'}{'contents'}[0]{'contents'}[0];
