...
$result_trees{'example_in_menu_description'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[3]{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'example_in_menu_description'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[3]{'contents'}[1]{'contents'}[0];
...
$result_trees{'example_in_menu_description'}{'contents'}[2]{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'example_in_menu_description'}{'contents'}[2]{'contents'}[1]{'contents'}[0];
...
$result_trees{'example_in_menu_description'}{'contents'}[2]{'extra'}{'misc_content'}[0] = $result_trees{'example_in_menu_description'}{'contents'}[2]{'args'}[0]{'contents'}[0];
...
$result_nodes{'example_in_menu_description'}{'menus'}[0]{'extra'}{'spaces_after_command_elt'}{'extra'}{'command'} = $result_nodes{'example_in_menu_description'}{'menus'}[0];
