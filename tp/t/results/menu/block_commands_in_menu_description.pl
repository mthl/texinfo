...
$result_trees{'block_commands_in_menu_description'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[3]{'contents'}[2]{'contents'}[1]{'contents'}[0]{'contents'}[0]{'extra'}{'misc_content'} = $result_trees{'block_commands_in_menu_description'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'args'}[3]{'contents'}[2]{'contents'}[1]{'contents'}[0]{'contents'}[0]{'args'}[0]{'contents'};
...
$result_trees{'block_commands_in_menu_description'}{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'block_commands_in_menu_description'}{'contents'}[2]{'args'}[0]{'contents'};
