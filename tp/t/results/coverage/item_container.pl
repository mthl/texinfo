...
$result_trees{'item_container'}{'contents'}[1]{'extra'}{'block_command_line_contents'}[0][0] = $result_trees{'item_container'}{'contents'}[1]{'args'}[0]{'contents'}[0];
...
$result_trees{'item_container'}{'contents'}[3]{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'item_container'}{'contents'}[3]{'contents'}[0]{'contents'}[0];
...
$result_trees{'item_container'}{'contents'}[3]{'extra'}{'block_command_line_contents'}[0][0] = $result_trees{'item_container'}{'contents'}[3]{'args'}[0]{'contents'}[0];
...
$result_trees{'item_container'}{'contents'}[5]{'extra'}{'block_command_line_contents'}[0][0] = $result_trees{'item_container'}{'contents'}[5]{'args'}[0];
...
$result_trees{'item_container'}{'contents'}[5]{'extra'}{'spaces_after_command_elt'} = $result_trees{'item_container'}{'contents'}[5]{'contents'}[0];
