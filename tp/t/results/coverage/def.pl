...
<dl class="def">
<dt id="index-d_002d_002deffn_005fname"><span class="category">c--ategory: </span><strong>d--effn_name</strong> <em>a--rguments...</em><a href=\'#index-d_002d_002deffn_005fname\' class=\'permalink\'>&para;</a></dt>
<dd><p>d&ndash;effn
</p></dd></dl>

<dl class="def">
<dt id="index-de_002d_002dffn_005fname"><span class="category">cate--gory: </span><strong>de--ffn_name</strong> <em>ar--guments    more args <br> even more so</em><a href=\'#index-de_002d_002dffn_005fname\' class=\'permalink\'>&para;</a></dt>
<dd><p>def&ndash;fn
</p></dd></dl>

<dl class="def">
<dt id="index-i"><span class="category">fset: </span><strong><var>i</var></strong> <em>a g</em><a href=\'#index-i\' class=\'permalink\'>&para;</a></dt>
<dt id="index-truc"><span class="category">cmde: </span><strong>truc</strong> <em></em><a href=\'#index-truc\' class=\'permalink\'>&para;</a></dt>
<dt id="index-log-trap"><span class="category">Command: </span><strong>log trap</strong> <em></em><a href=\'#index-log-trap\' class=\'permalink\'>&para;</a></dt>
<dt id="index-log-trap1"><span class="category">Command: </span><strong>log trap1</strong> <em></em><a href=\'#index-log-trap1\' class=\'permalink\'>&para;</a></dt>
<dt id="index-log-trap2"><span class="category">Command: </span><strong>log trap2</strong> <em></em><a href=\'#index-log-trap2\' class=\'permalink\'>&para;</a></dt>
<dt id="index-id-ule"><span class="category">cmde: </span><strong><b>id ule</b></strong> <em>truc</em><a href=\'#index-id-ule\' class=\'permalink\'>&para;</a></dt>
<dt id="index-id-i-ule"><span class="category">cmde2: </span><strong><b>id &lsquo;<samp>i</samp>&rsquo; ule</b></strong> <em>truc</em><a href=\'#index-id-i-ule\' class=\'permalink\'>&para;</a></dt>
<dt id="index-machin"><span class="category">: </span><strong>machin</strong><a href=\'#index-machin\' class=\'permalink\'>&para;</a></dt>
<dt id="index-bidule-machin"><span class="category">: </span><strong>bidule machin</strong><a href=\'#index-bidule-machin\' class=\'permalink\'>&para;</a></dt>
<dt id="index-machin-1"><span class="category">truc: </span><strong>machin</strong><a href=\'#index-machin-1\' class=\'permalink\'>&para;</a></dt>
<dt id="index-followed"><span class="category">truc: </span><strong>followed</strong> <em>by a comment</em><a href=\'#index-followed\' class=\'permalink\'>&para;</a></dt>
<dt id="index-after"><span class="category">truc: </span><strong>after</strong> <em>a deff item</em><a href=\'#index-after\' class=\'permalink\'>&para;</a></dt>
<dt id="index-deffnx"><span class="category">truc: </span><strong>deffnx</strong> <em>before end deffn</em><a href=\'#index-deffnx\' class=\'permalink\'>&para;</a></dt>
