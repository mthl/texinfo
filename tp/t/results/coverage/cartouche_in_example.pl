...
$result_trees{'cartouche_in_example'}{'contents'}[0]{'contents'}[2]{'extra'}{'spaces_after_command_elt'} = $result_trees{'cartouche_in_example'}{'contents'}[0]{'contents'}[2]{'contents'}[0];
...
$result_trees{'cartouche_in_example'}{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'cartouche_in_example'}{'contents'}[0]{'contents'}[0];
