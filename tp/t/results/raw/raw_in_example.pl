...
$result_trees{'raw_in_example'}{'contents'}[0]{'contents'}[1]{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'raw_in_example'}{'contents'}[0]{'contents'}[1]{'contents'}[0]{'contents'}[0];
...
$result_trees{'raw_in_example'}{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'raw_in_example'}{'contents'}[0]{'contents'}[0];
...
$result_trees{'raw_in_example'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'raw_in_example'}{'contents'}[2]{'contents'}[1]{'contents'}[1]{'contents'}[0];
...
$result_trees{'raw_in_example'}{'contents'}[2]{'contents'}[1]{'contents'}[3]{'extra'}{'spaces_after_command_elt'} = $result_trees{'raw_in_example'}{'contents'}[2]{'contents'}[1]{'contents'}[3]{'contents'}[0];
...
$result_trees{'raw_in_example'}{'contents'}[2]{'extra'}{'spaces_after_command_elt'} = $result_trees{'raw_in_example'}{'contents'}[2]{'contents'}[0];
