...
$result_trees{'braces_in_tex'}{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'braces_in_tex'}{'contents'}[1]{'contents'}[0];
...
$result_trees{'braces_in_tex'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'braces_in_tex'}{'contents'}[4]{'contents'}[1]{'contents'}[0]{'contents'}[0];
...
$result_trees{'braces_in_tex'}{'contents'}[4]{'extra'}{'spaces_after_command_elt'} = $result_trees{'braces_in_tex'}{'contents'}[4]{'contents'}[0];
