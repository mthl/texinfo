...
$result_trees{'complex_float'}{'contents'}[2]{'contents'}[7]{'args'}[1]{'extra'}{'spaces_before_argument'} = $result_trees{'complex_float'}{'contents'}[2]{'contents'}[7]{'args'}[1]{'contents'}[0];
...
$result_trees{'complex_float'}{'contents'}[4]{'contents'}[1]{'args'}[1]{'extra'}{'spaces_before_argument'} = $result_trees{'complex_float'}{'contents'}[4]{'contents'}[1]{'args'}[1]{'contents'}[0];
