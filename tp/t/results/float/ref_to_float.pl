...
$result_trees{'ref_to_float'}{'contents'}[0]{'args'}[1]{'extra'}{'spaces_before_argument'} = $result_trees{'ref_to_float'}{'contents'}[0]{'args'}[1]{'contents'}[0];
...
$result_trees{'ref_to_float'}{'contents'}[2]{'args'}[1]{'extra'}{'spaces_before_argument'} = $result_trees{'ref_to_float'}{'contents'}[2]{'args'}[1]{'contents'}[0];
