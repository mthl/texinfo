...
$result_trees{'defx_after_preformatted_with_text'}{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'defx_after_preformatted_with_text'}{'contents'}[0]{'contents'}[0];
