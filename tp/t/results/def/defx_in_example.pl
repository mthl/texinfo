...
$result_trees{'defx_in_example'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'line_nr'} = $result_trees{'defx_in_example'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'args'}[0]{'contents'}[0]{'line_nr'};
...
$result_trees{'defx_in_example'}{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'defx_in_example'}{'contents'}[0]{'contents'}[0];
