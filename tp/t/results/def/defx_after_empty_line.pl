...
$result_trees{'defx_after_empty_line'}{'contents'}[0]{'contents'}[0]{'extra'}{'index_entry'}{'content_normalized'} = $result_trees{'defx_after_empty_line'}{'contents'}[0]{'contents'}[0]{'extra'}{'index_entry'}{'content'};
...
$result_trees{'defx_after_empty_line'}{'contents'}[0]{'contents'}[2]{'extra'}{'index_entry'}{'content_normalized'} = $result_trees{'defx_after_empty_line'}{'contents'}[0]{'contents'}[2]{'extra'}{'index_entry'}{'content'};
