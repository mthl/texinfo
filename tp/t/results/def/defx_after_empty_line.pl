...
$result_trees{'defx_after_empty_line'}{'contents'}[0]{'contents'}[0]{'args'}[0]{'contents'}[8]{'parent'} = $result_trees{'defx_after_empty_line'}{'contents'}[0]{'contents'}[0]{'args'}[0];
...
$result_trees{'defx_after_empty_line'}{'contents'}[0]{'contents'}[2]{'args'}[0]{'contents'}[6]{'parent'} = $result_trees{'defx_after_empty_line'}{'contents'}[0]{'contents'}[2]{'args'}[0];
