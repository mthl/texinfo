...
$result_trees{'empty_def_arguments'}{'contents'}[0]{'contents'}[2]{'extra'}{'spaces_after_command'}{'extra'} = $result_trees{'empty_def_arguments'}{'contents'}[0]{'contents'}[2]{'args'}[0]{'contents'}[0]{'extra'};
