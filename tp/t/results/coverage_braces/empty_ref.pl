...
$result_trees{'empty_ref'}{'contents'}[1]{'contents'}[4]{'args'}[0]{'extra'}{'spaces_before_argument'} = $result_trees{'empty_ref'}{'contents'}[1]{'contents'}[4]{'args'}[0]{'contents'}[0];
...
$result_trees{'empty_ref'}{'contents'}[1]{'contents'}[7]{'args'}[0]{'extra'}{'spaces_before_argument'} = $result_trees{'empty_ref'}{'contents'}[1]{'contents'}[7]{'args'}[0]{'contents'}[0];
...
$result_trees{'empty_ref'}{'contents'}[1]{'contents'}[7]{'args'}[1]{'extra'}{'spaces_before_argument'} = $result_trees{'empty_ref'}{'contents'}[1]{'contents'}[7]{'args'}[1]{'contents'}[0];
