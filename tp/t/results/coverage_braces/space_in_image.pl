...
$result_trees{'space_in_image'}{'contents'}[0]{'args'}[0]{'extra'}{'spaces_before_argument'} = $result_trees{'space_in_image'}{'contents'}[0]{'args'}[0]{'contents'}[0];
...
$result_trees{'space_in_image'}{'contents'}[1]{'contents'}[1]{'args'}[0]{'extra'}{'spaces_before_argument'} = $result_trees{'space_in_image'}{'contents'}[1]{'contents'}[1]{'args'}[0]{'contents'}[0];
