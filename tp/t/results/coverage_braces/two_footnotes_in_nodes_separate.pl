...
$result_trees{'two_footnotes_in_nodes_separate'}{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'two_footnotes_in_nodes_separate'}{'contents'}[2]{'args'}[0]{'contents'};
...
$result_trees{'two_footnotes_in_nodes_separate'}{'contents'}[4]{'extra'}{'misc_content'} = $result_trees{'two_footnotes_in_nodes_separate'}{'contents'}[4]{'args'}[0]{'contents'};
