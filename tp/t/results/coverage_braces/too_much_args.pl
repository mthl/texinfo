...
$result_trees{'too_much_args'}{'contents'}[0]{'contents'}[0]{'args'}[1]{'extra'}{'spaces_before_argument'} = $result_trees{'too_much_args'}{'contents'}[0]{'contents'}[0]{'args'}[1]{'contents'}[0];
