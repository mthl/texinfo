...
$result_trees{'kbd'}{'contents'}[8]{'extra'}{'spaces_after_command_elt'} = $result_trees{'kbd'}{'contents'}[8]{'contents'}[0];
...
$result_trees{'kbd'}{'contents'}[12]{'extra'}{'spaces_after_command_elt'} = $result_trees{'kbd'}{'contents'}[12]{'contents'}[0];
