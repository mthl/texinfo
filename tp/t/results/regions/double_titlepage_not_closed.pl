...
$result_trees{'double_titlepage_not_closed'}{'contents'}[0]{'contents'}[5]{'extra'}{'spaces_after_command_elt'} = $result_trees{'double_titlepage_not_closed'}{'contents'}[0]{'contents'}[5]{'contents'}[0];
...
$result_trees{'double_titlepage_not_closed'}{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'double_titlepage_not_closed'}{'contents'}[0]{'contents'}[0];
