...
$result_trees{'ref_in_copying'}{'contents'}[0]{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'ref_in_copying'}{'contents'}[0]{'contents'}[0]{'contents'}[0];
...
$result_trees{'ref_in_copying'}{'contents'}[2]{'contents'}[4]{'extra'}{'spaces_after_command_elt'} = $result_trees{'ref_in_copying'}{'contents'}[2]{'contents'}[4]{'contents'}[0];
...
$result_trees{'ref_in_copying'}{'contents'}[2]{'extra'}{'misc_content'}[0] = $result_trees{'ref_in_copying'}{'contents'}[2]{'args'}[0]{'contents'}[0];
...
$result_trees{'ref_in_copying'}{'contents'}[4]{'extra'}{'misc_content'}[0] = $result_trees{'ref_in_copying'}{'contents'}[4]{'args'}[0]{'contents'}[0];
...
$result_nodes{'ref_in_copying'}{'menus'}[0]{'extra'}{'spaces_after_command_elt'}{'extra'}{'command'} = $result_nodes{'ref_in_copying'}{'menus'}[0];
