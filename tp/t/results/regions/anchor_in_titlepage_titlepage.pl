...
$result_trees{'anchor_in_titlepage_titlepage'}{'contents'}[0]{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'anchor_in_titlepage_titlepage'}{'contents'}[0]{'contents'}[0]{'contents'}[0];
...
$result_trees{'anchor_in_titlepage_titlepage'}{'contents'}[1]{'extra'}{'misc_content'}[0] = $result_trees{'anchor_in_titlepage_titlepage'}{'contents'}[1]{'args'}[0]{'contents'}[0];
