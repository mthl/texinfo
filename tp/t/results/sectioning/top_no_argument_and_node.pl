...
$result_trees{'top_no_argument_and_node'}{'contents'}[2]{'extra'}{'spaces_after_command_elt'} = $result_trees{'top_no_argument_and_node'}{'contents'}[2]{'args'}[0]{'contents'}[0];
...
$result_sectioning{'top_no_argument_and_node'}{'section_childs'}[0]{'extra'}{'spaces_after_command_elt'}{'extra'}{'command'} = $result_sectioning{'top_no_argument_and_node'}{'section_childs'}[0];
...
$result_nodes{'top_no_argument_and_node'}{'extra'}{'associated_section'}{'extra'}{'spaces_after_command_elt'}{'extra'}{'command'} = $result_nodes{'top_no_argument_and_node'}{'extra'}{'associated_section'};
