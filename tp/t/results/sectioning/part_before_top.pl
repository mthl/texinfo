...
$result_trees{'part_before_top'}[0]{'contents'}[1]{'extra'}{'misc_content'} = $result_trees{'part_before_top'}[0]{'contents'}[1]{'args'}[0]{'contents'};
...
$result_trees{'part_before_top'}[0]{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'part_before_top'}[0]{'contents'}[2]{'args'}[0]{'contents'};
