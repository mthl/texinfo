...
$result_trees{'section_before_top'}{'contents'}[4]{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'section_before_top'}{'contents'}[4]{'contents'}[1]{'contents'}[0];
...
$result_nodes{'section_before_top'}{'menus'}[0]{'extra'}{'spaces_after_command_elt'}{'extra'}{'command'} = $result_nodes{'section_before_top'}{'menus'}[0];
