...
$result_trees{'node_up_external_node'}[1]{'contents'}[0]{'args'}[1]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'node_up_external_node'}[1]{'contents'}[0]{'args'}[1];
...
$result_trees{'node_up_external_node'}[1]{'contents'}[0]{'args'}[2]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'node_up_external_node'}[1]{'contents'}[0]{'args'}[2];
...
$result_trees{'node_up_external_node'}[1]{'contents'}[0]{'args'}[3]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'node_up_external_node'}[1]{'contents'}[0]{'args'}[3];
