...
$result_trees{'empty_node'}{'contents'}[2]{'args'}[1]{'extra'}{'spaces_before_argument'} = $result_trees{'empty_node'}{'contents'}[2]{'args'}[1]{'contents'}[0];
...
$result_trees{'empty_node'}{'contents'}[2]{'args'}[2]{'extra'}{'spaces_before_argument'} = $result_trees{'empty_node'}{'contents'}[2]{'args'}[2]{'contents'}[0];
...
$result_trees{'empty_node'}{'contents'}[2]{'args'}[3]{'extra'}{'spaces_before_argument'} = $result_trees{'empty_node'}{'contents'}[2]{'args'}[3]{'contents'}[0];
