...
$result_trees{'empty_node'}{'contents'}[2]{'args'}[1]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'empty_node'}{'contents'}[2]{'args'}[1];
...
$result_trees{'empty_node'}{'contents'}[2]{'args'}[2]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'empty_node'}{'contents'}[2]{'args'}[2];
...
$result_trees{'empty_node'}{'contents'}[2]{'args'}[3]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'empty_node'}{'contents'}[2]{'args'}[3];
