...
$result_trees{'anchor_in_footnote'}{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'anchor_in_footnote'}{'contents'}[2]{'args'}[0]{'contents'};
...
$result_trees{'anchor_in_footnote'}{'contents'}[4]{'extra'}{'misc_content'} = $result_trees{'anchor_in_footnote'}{'contents'}[4]{'args'}[0]{'contents'};
