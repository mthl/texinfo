...
$result_trees{'contents_in_html_text'}{'contents'}[1]{'extra'}{'misc_content'} = $result_trees{'contents_in_html_text'}{'contents'}[1]{'args'}[0]{'contents'};
...
$result_trees{'contents_in_html_text'}{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'contents_in_html_text'}{'contents'}[2]{'args'}[0]{'contents'};
...
$result_trees{'contents_in_html_text'}{'contents'}[3]{'extra'}{'misc_content'} = $result_trees{'contents_in_html_text'}{'contents'}[3]{'args'}[0]{'contents'};
...
$result_trees{'contents_in_html_text'}{'contents'}[4]{'extra'}{'misc_content'} = $result_trees{'contents_in_html_text'}{'contents'}[4]{'args'}[0]{'contents'};
