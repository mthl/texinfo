...
$result_trees{'next_no_prev_to_node'}{'contents'}[2]{'args'}[1]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'next_no_prev_to_node'}{'contents'}[2]{'args'}[1];
...
$result_trees{'next_no_prev_to_node'}{'contents'}[2]{'args'}[3]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'next_no_prev_to_node'}{'contents'}[2]{'args'}[3];
...
$result_trees{'next_no_prev_to_node'}{'contents'}[3]{'args'}[3]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'next_no_prev_to_node'}{'contents'}[3]{'args'}[3];
