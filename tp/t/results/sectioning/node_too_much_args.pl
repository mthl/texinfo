...
$result_trees{'node_too_much_args'}{'contents'}[1]{'args'}[1]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'node_too_much_args'}{'contents'}[1]{'args'}[1];
$result_trees{'node_too_much_args'}{'contents'}[1]{'args'}[1]{'parent'} = $result_trees{'node_too_much_args'}{'contents'}[1];
$result_trees{'node_too_much_args'}{'contents'}[1]{'args'}[2]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'node_too_much_args'}{'contents'}[1]{'args'}[2];
...
$result_trees{'node_too_much_args'}{'contents'}[1]{'args'}[3]{'extra'}{'spaces_before_argument'}{'parent'} = $result_trees{'node_too_much_args'}{'contents'}[1]{'args'}[3];
