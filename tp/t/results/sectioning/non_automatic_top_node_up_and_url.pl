...
$result_trees{'non_automatic_top_node_up_and_url'}[0]{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'non_automatic_top_node_up_and_url'}[0]{'contents'}[2]{'args'}[0]{'contents'};
