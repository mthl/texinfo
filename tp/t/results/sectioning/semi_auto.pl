...
$result_trees{'semi_auto'}{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'semi_auto'}{'contents'}[2]{'args'}[0]{'contents'};
...
$result_trees{'semi_auto'}{'contents'}[4]{'extra'}{'misc_content'} = $result_trees{'semi_auto'}{'contents'}[4]{'args'}[0]{'contents'};
...
$result_trees{'semi_auto'}{'contents'}[6]{'extra'}{'misc_content'} = $result_trees{'semi_auto'}{'contents'}[6]{'args'}[0]{'contents'};
...
$result_trees{'semi_auto'}{'contents'}[8]{'extra'}{'misc_content'} = $result_trees{'semi_auto'}{'contents'}[8]{'args'}[0]{'contents'};
