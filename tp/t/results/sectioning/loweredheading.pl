...
$result_trees{'loweredheading'}{'contents'}[1]{'contents'}[0]{'extra'}{'misc_content'} = $result_trees{'loweredheading'}{'contents'}[1]{'contents'}[0]{'args'}[0]{'contents'};
$result_trees{'loweredheading'}{'contents'}[1]{'contents'}[0]{'parent'} = $result_trees{'loweredheading'}{'contents'}[1];
$result_trees{'loweredheading'}{'contents'}[1]{'extra'}{'misc_content'} = $result_trees{'loweredheading'}{'contents'}[1]{'args'}[0]{'contents'};
