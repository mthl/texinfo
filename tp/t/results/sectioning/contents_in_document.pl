...
$result_trees{'contents_in_document'}{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'contents_in_document'}{'contents'}[2]{'args'}[0]{'contents'};
...
$result_trees{'contents_in_document'}{'contents'}[3]{'extra'}{'misc_content'} = $result_trees{'contents_in_document'}{'contents'}[3]{'args'}[0]{'contents'};
