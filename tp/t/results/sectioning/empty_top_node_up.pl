...
$result_trees{'empty_top_node_up'}{'contents'}[2]{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'empty_top_node_up'}{'contents'}[2]{'contents'}[1]{'contents'}[0];
...
$result_trees{'empty_top_node_up'}{'contents'}[2]{'extra'}{'misc_content'}[0] = $result_trees{'empty_top_node_up'}{'contents'}[2]{'args'}[0]{'contents'}[0];
...
$result_nodes{'empty_top_node_up'}{'menus'}[0]{'extra'}{'spaces_after_command_elt'}{'extra'}{'command'} = $result_nodes{'empty_top_node_up'}{'menus'}[0];
