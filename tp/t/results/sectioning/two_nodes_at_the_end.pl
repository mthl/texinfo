...
$result_trees{'two_nodes_at_the_end'}[0]{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'two_nodes_at_the_end'}[0]{'contents'}[2]{'args'}[0]{'contents'};
...
$result_trees{'two_nodes_at_the_end'}[1]{'contents'}[1]{'extra'}{'misc_content'} = $result_trees{'two_nodes_at_the_end'}[1]{'contents'}[1]{'args'}[0]{'contents'};
