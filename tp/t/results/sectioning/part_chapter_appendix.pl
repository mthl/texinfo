...
$result_trees{'part_chapter_appendix'}{'contents'}[1]{'extra'}{'misc_content'} = $result_trees{'part_chapter_appendix'}{'contents'}[1]{'args'}[0]{'contents'};
...
$result_trees{'part_chapter_appendix'}{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'part_chapter_appendix'}{'contents'}[2]{'args'}[0]{'contents'};
...
$result_trees{'part_chapter_appendix'}{'contents'}[3]{'extra'}{'misc_content'} = $result_trees{'part_chapter_appendix'}{'contents'}[3]{'args'}[0]{'contents'};
