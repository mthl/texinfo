...
$result_trees{'contents_at_end_document_after_node'}{'contents'}[2]{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'contents_at_end_document_after_node'}{'contents'}[2]{'contents'}[1]{'contents'}[0];
...
$result_trees{'contents_at_end_document_after_node'}{'contents'}[2]{'extra'}{'misc_content'}[0] = $result_trees{'contents_at_end_document_after_node'}{'contents'}[2]{'args'}[0]{'contents'}[0];
...
$result_trees{'contents_at_end_document_after_node'}{'contents'}[3]{'extra'}{'misc_content'}[0] = $result_trees{'contents_at_end_document_after_node'}{'contents'}[3]{'args'}[0]{'contents'}[0];
...
$result_nodes{'contents_at_end_document_after_node'}{'menus'}[0]{'extra'}{'spaces_after_command_elt'}{'extra'}{'command'} = $result_nodes{'contents_at_end_document_after_node'}{'menus'}[0];
