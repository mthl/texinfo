...
$result_trees{'no_argument_and_contents'}{'contents'}[1]{'extra'}{'misc_content'} = $result_trees{'no_argument_and_contents'}{'contents'}[1]{'args'}[0]{'contents'};
...
$result_trees{'no_argument_and_contents'}{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'no_argument_and_contents'}{'contents'}[2]{'args'}[0]{'contents'};
