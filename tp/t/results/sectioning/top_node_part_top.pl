...
$result_trees{'top_node_part_top'}[0]{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'top_node_part_top'}[0]{'contents'}[2]{'args'}[0]{'contents'};
...
$result_trees{'top_node_part_top'}[0]{'contents'}[3]{'extra'}{'misc_content'} = $result_trees{'top_node_part_top'}[0]{'contents'}[3]{'args'}[0]{'contents'};
