...
$result_trees{'chapter_before_part'}[0]{'contents'}[1]{'extra'}{'misc_content'} = $result_trees{'chapter_before_part'}[0]{'contents'}[1]{'args'}[0]{'contents'};
...
$result_trees{'chapter_before_part'}[1]{'contents'}[0]{'extra'}{'misc_content'} = $result_trees{'chapter_before_part'}[1]{'contents'}[0]{'args'}[0]{'contents'};
