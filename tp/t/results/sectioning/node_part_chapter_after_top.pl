...
$result_trees{'node_part_chapter_after_top'}[0]{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'node_part_chapter_after_top'}[0]{'contents'}[2]{'args'}[0]{'contents'};
...
$result_trees{'node_part_chapter_after_top'}[1]{'contents'}[1]{'extra'}{'misc_content'} = $result_trees{'node_part_chapter_after_top'}[1]{'contents'}[1]{'args'}[0]{'contents'};
...
$result_trees{'node_part_chapter_after_top'}[1]{'contents'}[2]{'extra'}{'misc_content'} = $result_trees{'node_part_chapter_after_top'}[1]{'contents'}[2]{'args'}[0]{'contents'};
