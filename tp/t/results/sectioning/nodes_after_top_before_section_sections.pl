...
$result_trees{'nodes_after_top_before_section_sections'}[0]{'contents'}[4]{'extra'}{'misc_content'} = $result_trees{'nodes_after_top_before_section_sections'}[0]{'contents'}[4]{'args'}[0]{'contents'};
