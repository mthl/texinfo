...
$result_trees{'section_before_top_no_node'}{'contents'}[1]{'extra'}{'misc_content'}[0] = $result_trees{'section_before_top_no_node'}{'contents'}[1]{'args'}[0]{'contents'}[0];
...
$result_trees{'section_before_top_no_node'}{'contents'}[2]{'extra'}{'misc_content'}[0] = $result_trees{'section_before_top_no_node'}{'contents'}[2]{'args'}[0]{'contents'}[0];
