...
$result_trees{'no_documentencoding_and_insertions'}{'contents'}[3]{'extra'}{'spaces_after_command_elt'} = $result_trees{'no_documentencoding_and_insertions'}{'contents'}[3]{'contents'}[0];
