...
$result_trees{'test_deftypefnnewline'}{'contents'}[1]{'contents'}[0]{'contents'}[0]{'extra'}{'index_entry'}{'content_normalized'} = $result_trees{'test_deftypefnnewline'}{'contents'}[1]{'contents'}[0]{'contents'}[0]{'extra'}{'index_entry'}{'content'};
...
$result_trees{'test_deftypefnnewline'}{'contents'}[1]{'contents'}[2]{'contents'}[0]{'extra'}{'index_entry'}{'content_normalized'} = $result_trees{'test_deftypefnnewline'}{'contents'}[1]{'contents'}[2]{'contents'}[0]{'extra'}{'index_entry'}{'content'};
...
$result_trees{'test_deftypefnnewline'}{'contents'}[1]{'contents'}[6]{'contents'}[0]{'extra'}{'index_entry'}{'content_normalized'} = $result_trees{'test_deftypefnnewline'}{'contents'}[1]{'contents'}[6]{'contents'}[0]{'extra'}{'index_entry'}{'content'};
...
$result_trees{'test_deftypefnnewline'}{'contents'}[1]{'contents'}[8]{'contents'}[0]{'extra'}{'index_entry'}{'content_normalized'} = $result_trees{'test_deftypefnnewline'}{'contents'}[1]{'contents'}[8]{'contents'}[0]{'extra'}{'index_entry'}{'content'};
...
<dl class="def">
<dt id="index-name"><span class="category">Function:<br> </span><em>data-type</em><br> <strong>name</strong> <em>arguments...</em><a href=\'#index-name\' class=\'copiable-anchor\'>&para;</a></dt>
<dd><p>aaa
</p></dd></dl>

<dl class="def">
<dt id="index-arg"><span class="category">fun: </span><strong>arg</strong><a href=\'#index-arg\' class=\'copiable-anchor\'>&para;</a></dt>
<dd><p>fff
</p></dd></dl>


<dl class="def">
<dt id="index-name2"><span class="category">Function: </span><em>data-type2</em> <strong>name2</strong> <em>arguments2...</em><a href=\'#index-name2\' class=\'copiable-anchor\'>&para;</a></dt>
<dd><p>aaa2
</p></dd></dl>

<dl class="def">
<dt id="index-arg2"><span class="category">fun2: </span><strong>arg2</strong><a href=\'#index-arg2\' class=\'copiable-anchor\'>&para;</a></dt>
<dd><p>fff2
</p></dd></dl>
<hr>
';
