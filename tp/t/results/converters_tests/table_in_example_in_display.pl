...
$result_trees{'table_in_example_in_display'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[0]{'contents'}[0]{'contents'}[0]{'extra'}{'misc_content'}[0] = $result_trees{'table_in_example_in_display'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'contents'}[0]{'contents'}[0]{'contents'}[0]{'args'}[0]{'contents'}[0];
...
$result_trees{'table_in_example_in_display'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'extra'}{'block_command_line_contents'}[0][0] = $result_trees{'table_in_example_in_display'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'args'}[0]{'contents'}[0];
...
$result_trees{'table_in_example_in_display'}{'contents'}[0]{'contents'}[1]{'extra'}{'spaces_after_command_elt'} = $result_trees{'table_in_example_in_display'}{'contents'}[0]{'contents'}[1]{'contents'}[0];
...
$result_trees{'table_in_example_in_display'}{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'table_in_example_in_display'}{'contents'}[0]{'contents'}[0];
