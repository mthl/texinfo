...
$result_trees{'at_commands_glued_in_example'}{'contents'}[0]{'contents'}[1]{'contents'}[31]{'extra'}{'spaces_after_command_elt'}{'extra'}{'command'} = $result_trees{'at_commands_glued_in_example'}{'contents'}[0]{'contents'}[1]{'contents'}[31];
$result_trees{'at_commands_glued_in_example'}{'contents'}[0]{'contents'}[1]{'contents'}[31]{'extra'}{'spaces_after_command_elt'}{'parent'} = $result_trees{'at_commands_glued_in_example'}{'contents'}[0]{'contents'}[1];
...
$result_trees{'at_commands_glued_in_example'}{'contents'}[0]{'contents'}[1]{'contents'}[32] = $result_trees{'at_commands_glued_in_example'}{'contents'}[0]{'contents'}[1]{'contents'}[31]{'extra'}{'spaces_after_command_elt'};
...
$result_trees{'at_commands_glued_in_example'}{'contents'}[0]{'extra'}{'spaces_after_command_elt'} = $result_trees{'at_commands_glued_in_example'}{'contents'}[0]{'contents'}[0];
