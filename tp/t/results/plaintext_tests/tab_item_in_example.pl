...
$result_trees{'tab_item_in_example'}{'contents'}[0]{'contents'}[3]{'args'}[0]{'contents'}[1]{'parent'} = $result_trees{'tab_item_in_example'}{'contents'}[0]{'contents'}[3]{'args'}[0];
$result_trees{'tab_item_in_example'}{'contents'}[0]{'contents'}[3]{'args'}[0]{'contents'}[2]{'parent'} = $result_trees{'tab_item_in_example'}{'contents'}[0]{'contents'}[3]{'args'}[0];
...
$result_trees{'tab_item_in_example'}{'contents'}[0]{'contents'}[3]{'extra'}{'spaces_after_command'} = $result_trees{'tab_item_in_example'}{'contents'}[0]{'contents'}[3]{'args'}[0]{'contents'}[0];
...
$result_trees{'tab_item_in_example'}{'contents'}[0]{'extra'}{'spaces_after_command'} = $result_trees{'tab_item_in_example'}{'contents'}[0]{'contents'}[0];
