...
$result_trees{'no_arg_brace_command_on_table_line'}{'contents'}[0]{'line_nr'} = $result_trees{'no_arg_brace_command_on_table_line'}{'contents'}[0]{'args'}[0]{'contents'}[0]{'line_nr'};
